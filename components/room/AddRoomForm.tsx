        ...
        <Form {...form}>
            <form className='space-y-6'>
                ...
                <div className='pt-4 pb-2'>
                    {room ? <Button onClick={form.handleSubmit(onSubmit)} type='button' className='max-w-[150px]' disabled={isLoading}>{isLoading ? <><Loader2 className='mr-2 h-4 w-4' /> Updating</> : <><PencilLine className='mr-2 h-4 w-4' /> Update</>}</Button> : <Button onClick={form.handleSubmit(onSubmit)} type='button' className='max-w-[150px]' disabled={isLoading}>
